...
function drop(ev) {
    ...
    /**
     * work, but need time to improve.
     * console.log(document.getElementById(data));
     * var canvas = document.getElementById('wgsn_canvas');
     * var context = canvas.getContext('2d');
     * var base_image = new Image();
     * base_image.src = document.getElementById(data).getAttribute('src');
     * base_image.onload = function() {
     *    context.drawImage(base_image, 100, 100);
     * }
     * ev.target is canvas, but how about layers? re-use.
     */
    $('#' + data).trigger('click');
}